...
class APIRequestBuilder {
    ...
    func responseModel<T: Decodable>(model: T.Type, completion: @escaping (Result<T, Error>) -> Void) {
        APIManager.shared.apiRequest(apiName: apiName, pathVariables: pathVariables, parameters: parameters, headers: headers, typeHolder: TypeHolder<T>(), completion: completion)
    }
}
...
class APIManager {
    ...
    func apiRequest<T: Decodable>(apiName: String, pathVariables: [String: String]? = nil, parameters: [String: String]? = nil, headers: [String: String], typeHolder: TypeHolder<T>, completion: @escaping (Result<T, Error>) -> Void) {
