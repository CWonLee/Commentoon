...
internal enum Asset {
  internal enum Color {
    internal static let bluePointColor = ColorAsset(name: "bluePointColor")
  ...
  internal enum Image {
    internal static let btnKakaoLogin = ImageAsset(name: "btnKakaoLogin")
    internal static let icBackArrow = ImageAsset(name: "icBackArrow")
    ...
    internal static let icSelectedTabMy = ImageAsset(name: "icSelectedTabMy")
    internal static let icSelectedTabRanking = ImageAsset(name: "icSelectedTabRanking")
    internal static let icSelectedTabSearch = ImageAsset(name: "icSelectedTabSearch")
    internal static let icSetting = ImageAsset(name: "icSetting")
    internal static let icStar = ImageAsset(name: "icStar")
    internal static let icTabHome = ImageAsset(name: "icTabHome")
    internal static let icTabMy = ImageAsset(name: "icTabMy")
    internal static let icTabRanking = ImageAsset(name: "icTabRanking")
    internal static let icTabSearch = ImageAsset(name: "icTabSearch")
    internal static let icYellowStar = ImageAsset(name: "icYellowStar")
  }
}
